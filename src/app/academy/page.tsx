  ...
  return (
    <div className="pt-28 pb-20 bg-surface-light min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Free Promised Career Resources Section */}
        <div className="my-16 bg-white rounded-3xl p-8 sm:p-10 border border-gray-200/80 shadow-card">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 pb-6 border-b border-gray-100">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-navy-950 mt-2">
                Free Student Tools &amp; Complete Syllabus
              </h2>
              <p className="text-xs sm:text-sm text-gray-500 mt-1">
                Everything you need to kickstart your IT career—crafted by senior engineers in Kadapa.
              </p>
            </div>
            <span className="text-xs font-semibold text-gray-400">
              Instant Access · No Sign-in Required
            </span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Card 1: ATS Resume Template */}
            <div className="p-6 rounded-2xl bg-gray-50 border border-gray-200/70 hover:border-brand-300 hover:bg-brand-50/20 transition-all flex flex-col justify-between">
              <div>
                <div className="w-10 h-10 rounded-xl bg-brand-100 text-brand-700 flex items-center justify-center mb-4 font-bold">
                ...
                <p className="text-xs text-gray-600 mt-1.5 mb-4 leading-relaxed">
                  Tailored for Software QA, Test Automation, and Java Full-Stack freshers. Formatted to pass corporate Applicant Tracking Systems (ATS) used by TCS, Infosys, Wipro, and high-growth startups.
                </p>
              </div>

              <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-gray-200/60">
                <a
                  href="/downloads/resume-template.html"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-navy-950 hover:bg-navy-900 text-white text-xs font-bold transition-colors"
                >
                ...
                <a
                  ...
                  download
                  className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white hover:bg-gray-100 border border-gray-200 text-xs font-bold text-gray-700 transition-colors"
                >
            ...
            <div className="p-6 rounded-2xl bg-gray-50 border border-gray-200/70 hover:border-brand-300 hover:bg-brand-50/20 transition-all flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-lg font-extrabold text-navy-950">
                  Full 16-Week Course Syllabus (2026 Edition)
                </h3>
                <p className="text-xs text-gray-600 mt-1.5 mb-4 leading-relaxed">
                  Detailed week-by-week curriculum covering Manual QA, Core Java, Selenium WebDriver 4, TestNG, Cucumber BDD, REST Assured, and CI/CD Jenkins pipelines with live capstone project briefs.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-gray-200/60">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-brand-500 to-brand-600 hover:from-brand-600 hover:to-brand-700 text-white text-xs font-bold transition-all shadow-sm"
                >
